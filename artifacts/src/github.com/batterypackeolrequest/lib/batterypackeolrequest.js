...
class BatteryPackEOLRequest extends Contract {
    ...
    async createBatteryPackEOLRequest(ctx, batteryPackEOLRequestNumber, BatteryAssetNumber, BatteryPackSerialNumber, BatteryPackExternalID,
        ...
        ReturnStatusTimestamp, ServiceProviderOrgCode, ServiceProviderOrgName, ServiceProviderLocationFullAddress,ServiceProviderLatitude, ServiceProviderLongitude, 
        ...
        RestarProviderLocationFullAddress, RestarProviderLocationLat, RestarProviderLocationLong, DropoffScheduleDate, RestarCertHash) {
