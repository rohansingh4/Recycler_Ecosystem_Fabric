...
export PRIVATE_DATA_CONFIG=${PWD}/artifacts/private-data/collections_config_4.json


export CHANNEL_NAME1="eolchannel4"
...
setGlobalsForPeer1RestarOrg1(){
    export CORE_PEER_LOCALMSPID="RestarOrg1MSP"
    export CORE_PEER_TLS_ROOTCERT_FILE=$PEER0_ORG4_CA
    export CORE_PEERMSPCONFIGPATH=${PWD}/artifacts/channel/crypto-config/peerOrganizations/restarorg1.example.com/users/Admin@restarorg1.example.com/msp
    export CORE_PEER_ADDRESS=localhost:14051
    
}   
# presetup

CHANNEL_NAME1="eolchannel4"
