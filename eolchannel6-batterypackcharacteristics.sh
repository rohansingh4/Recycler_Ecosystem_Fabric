...
export PRIVATE_DATA_CONFIG=${PWD}/artifacts/private-data/collections_config_6.json


export CHANNEL_NAME1="eolchannel6"
...
installChaincode() {
    ...
    setGlobalsForPeer0RestarOrg3
    peer lifecycle chaincode install ${CC_NAME}.tar.gz
    echo "===================== Chaincode is installed on peer0.RestarOrg3 ===================== "
}
# installChaincode
...
queryInstalled4() {
    ...
    PACKAGE_ID=$(sed -n "/${CC_NAME}_${VERSION}/{s/^Package ID: //; s/, Label:.*$//; p;}" log.txt)
    echo PackageID is ${PACKAGE_ID}
    echo "===================== Query installed successful on peer0.RestarOrg3 on channel ===================== "
}
# queryInstalled4
...
approveForMyOrg1() {
    ...
    echo "===================== chaincode approved from ServiceOrg3 ===================== "
...
# --peerAddresses localhost:19051 --tlsRootCertFiles $PEER0_ORG7_CA --peerAddresses localhost:9051 --tlsRootCertFiles $PEER0_ORG2_CA
# --peerAddresses peer0.org1.example.com:19051 --tlsRootCertFiles $PEER0_ORG7_CA --peerAddresses peer0.org2.example.com:9051 --tlsRootCertFiles $PEER0_ORG2_CA
...
approveForMyOrg4() {
    ...
    echo "===================== chaincode approved from RestarOrg3 ===================== "
}
# approveForMyOrg4
...
chaincodeInvoke() {
    ...
    #     --tlsRootCertFiles $PEER0_ORG7_CA \
    #     --peerAddresses localhost:9051 --tlsRootCertFiles $PEER0_ORG2_CA   \
