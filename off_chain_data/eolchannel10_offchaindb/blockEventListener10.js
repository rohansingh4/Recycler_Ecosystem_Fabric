...
async function main() {
    try {
        ...
        if (!userExists) {
            console.log('An identity for the user "appUser10" does not exist in the wallet');
        ...
        await gateway.connect(ccp, { wallet, identity: 'appUser10', discovery: { enabled: true, asLocalhost: true } });

        // Get the network (channel) our contract is deployed to.
        const network = await gateway.getNetwork('eolchannel10');
