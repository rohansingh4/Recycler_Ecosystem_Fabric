...
async function main() {
    ...
    try {
        ...
        const contract = network.getContract('batterypackcharacteristics');
        ...
        //     var randomValue = Math.floor(Math.random() * (9));
            ...
            await contract.submitTransaction('createBatteryPackCharacteristics', "one", "2", "3", "fo4", "5", "6", "seven", "eight", "9nine", "10", "12", "13", "14", "15", "16", "17");
            // console.log("Adding asset:", batteryPackData);
