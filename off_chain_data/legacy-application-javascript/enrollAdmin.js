...
async function main() {
    try {
        ...
        const caURL = ccp.certificateAuthorities['ca.serviceorg1.example.com'].url;
...
// rohan@rohan:~/fabric/recycler/recycler-ecosystem/recycler_ecosystem_fabric/off_chain_data/legacy-application-javascript$ node enrollAdmin.js
